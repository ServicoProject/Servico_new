      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="py-16">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="tel:+919059886228" className="text-gray-300 hover:text-white transition-colors text-sm">
                      +91 9059886228
                    </a>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Mail className="w-4 h-4 text-blue-400 flex-shrink-0" />
                    <a href="mailto:sridhar.serviqo@gmail.com" className="text-gray-300 hover:text-white transition-colors text-sm">
                  ...
                  <div className="flex items-center space-x-3">
                    {socialLinks.map((social, index) => (
                      <a
                        key={index}
                        href={social.href}
                        className="w-8 h-8 bg-gray-900 border border-gray-700 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:bg-gray-800 hover:border-gray-600 transition-all duration-300"
            ...
            {/* Solutions - Column 2 */}
            <div className="lg:col-span-1">
              <h4 className="text-white font-semibold mb-4 text-sm">Our Solutions</h4>
              <ul className="space-y-2">
                {solutions.map((solution, index) => (
                  <li key={index}>
                    <button 
                      onClick={solution.action}
                      className="text-gray-300 hover:text-white transition-colors text-sm flex items-center group w-full text-left"
                    >
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="max-w-2xl mx-auto text-center">
              <h3 className="text-lg font-bold text-white mb-3" style={{ fontFamily: "'Playfair Display', Georgia, 'Times New Roman', serif" }}>
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 max-w-md mx-auto">
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="Enter your email address"
                  className="flex-1 px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 transition-colors text-sm"
                  required
                />
                <button
                  type="submit"
                  className="btn-primary px-4 py-2 whitespace-nowrap text-sm"
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700">
              <div className="text-center">
                <h3 className="text-lg font-bold text-white mb-4" style={{ fontFamily: "'Playfair Display', Georgia, 'Times New Roman', serif" }}>
                  24/7 Technical Support for Existing Clients
                </h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="flex items-center justify-center space-x-2">
                    <Phone className="w-4 h-4 text-red-400" />
                    <span className="text-gray-300 text-xs">Emergency Hotline</span>
                  </div>
                  <div className="flex items-center justify-center space-x-2">
                    <Users className="w-4 h-4 text-green-400" />
                    <span className="text-gray-300 text-xs">Live Chat Available</span>
                  </div>
                  <div className="flex items-center justify-center space-x-2">
                    <Mail className="w-4 h-4 text-blue-400" />
                    <span className="text-gray-300 text-xs">Support Email</span>
                  </div>
                  <div className="flex items-center justify-center space-x-2">
                    <ExternalLink className="w-4 h-4 text-purple-400" />
                    <span className="text-gray-300 text-xs">Support Portal</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="py-6 border-t border-gray-800">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center items-center space-x-4 text-gray-400 text-xs mb-3">
