            ...
            <div key={index} className={`p-8 rounded-xl transition-all duration-500 hover:shadow-lg hover:scale-105 group bg-gray-900 border-2 ${
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="leading-relaxed text-gray-300 group-hover:text-gray-200" style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif" }}>{reason.description}</p>
                </div>
              </div>
            </div>
          ))}
